...
connection = pymysql.connect(host='localhost', user='root', password='14563@#Reji', db='ai_app')
...
def run():
    ...
    st.sidebar.markdown("[FAQs](https://rejinoldjohnson.github.io/FAQ/) <br>", unsafe_allow_html=True)
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                st.markdown('''<h6 style='text-align: left; color: #FFFF00;'>* Add more projects related to the recommended field</h6>''', unsafe_allow_html=True)
                st.markdown('''<h6 style='text-align: left; color: #FFFF00;'>* Add links to your GitHub or portfolio</h6>''', unsafe_allow_html=True)
